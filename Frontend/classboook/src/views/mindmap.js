                    ...
                    <div className='Frame20NewMindMap'>
                        <span className='Frame8'>
                            <Link to="/mindmap" className='Frame3' onClick={this.HandleMindMap}>
                                ...
                                <div className='Frame3Text' style={{ color: "#000" }}>Sơ đồ tư duy</div>
                            </Link>
