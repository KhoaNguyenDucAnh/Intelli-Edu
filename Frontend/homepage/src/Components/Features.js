...
function Features() {
    return(
        <div className="features">
            <img className="featureDescription" src={require('../images/featuredescription.png')}/>
            <div className='feature'>
                <div className='featureContent'>
                    ...
                    <img className='featureName' src={require('../images/featurename1.png')}/>
                    <p className='featureContentText'> Sử dụng trí tuệ nhân tạo và bộ câu hỏi được cá nhân hóa để kiểm tra và tổng ôn bài học</p>
                    <Comeherebutton />
                </div>
                <img className='featurePicture' src={require('../images/feaaturepicture1.png')}/>
            </div>
            <div className='feature'>
                <img className='featurePicture' src={require('../images/feaaturepicture2.png')}/>
                <div className='featureContent'>
                    <div className='featureContentHeader'>
                        <div className='line'/>
                        <p className='featureContentHeaderText'>LÊN KẾ HOẠCH RÕ RÀNG</p>
                    </div>
                    <img className='featureName' src={require('../images/featurename2.png')}/>
            ...
            <div className='feature'>
                <div className='featureContent'>
                    ...
                    <img className='featureName' src={require('../images/featurename3.png')}/>
                ...
                <img className='featurePicture' src={require('../images/feaaturepicture3.png')}/>
            </div>
        </div>
    )
}
