...
def to_mindmap(file: str):
    ...
    mindmap = claude_api.send_message(
        """
        Human: We want a comprehensive mind map in vietnamese for this text in a json structure with the folowing structure: 'title' -> 'root' -> 'label' -> 'children'. Give additional details and statistics if needed.
