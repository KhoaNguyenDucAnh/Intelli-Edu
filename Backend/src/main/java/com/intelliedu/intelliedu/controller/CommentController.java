...
public class CommentController {
  ...
  private CommentService commentService;
	...
	@GetMapping("/{postId}")
	public Map<String, Page<CommentDto>> findComment(@PathVariable UUID postId, Authentication authentication, Pageable pageable) {
		return commentService.findComment(postId, authentication, pageable);
	}

  @PostMapping("/{postId}")
  public CommentDto createComment(@PathVariable UUID postId, @RequestBody CommentDto commentDto, Authentication authentication) {
    return commentService.createComment(postId, commentDto, authentication);
  }

  @PutMapping("/{id}")
  public CommentDto updateComment(@PathVariable UUID id, @RequestBody CommentDto commentDto, Authentication authentication) {
